...
/*
 OPMODE expresses operation mode for controlling screw speed (SNW).
  USE_F:   SNW = alpha * F                                 
  USE_E:   SNW = alpha * deltaE                            
  USE_F_E: SNW = alpha * F * deltaE                        
  USE_F_E_DIV: SNW = alpha * F * deltaE / sqrt(dX^2+dY^2)  
*/
#define USE_F 1
#define USE_E 2
#define USE_F_E 3
#define USE_F_E_DIV 4
#define OPMODE USE_F
// #define OPMODE USE_E
...
#define ATC_MIN_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop.
